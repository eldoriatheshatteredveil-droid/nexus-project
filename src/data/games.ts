...
export const GAMES: Game[] = [
  ...
  },
  {
    ...
    tags: ['Puzzle', 'Logic', 'Nexus Exclusive', 'Strategy', 'Single Player'],
    rating: 4.8,
    downloads: 892,
    category: 'nvious',
    mode: 'singleplayer'
  },
  {
    ...
    tags: ['Puzzle', 'Trivia', 'Nexus Exclusive', 'AI', 'Single Player'],
    rating: 4.9,
    downloads: 404,
    category: 'nvious',
    mode: 'singleplayer'
  },
  {
    ...
    tags: ['Arcade', 'Retro', 'Nexus Original', 'Sports', 'Reaction', 'Multiplayer'],
    rating: 4.7,
    downloads: 42,
    category: 'nvious',
    mode: 'multiplayer'
  },
  {
    ...
    tags: ['Arcade', 'Retro', 'Nexus Original', 'Action', 'Physics', 'Single Player'],
    rating: 4.9,
    downloads: 0,
    category: 'nvious',
    mode: 'singleplayer'
  },
  {
    ...
    tags: ['Arcade', 'Shooter', 'Nexus Original', 'Action', 'Retro', 'Single Player'],
    rating: 4.8,
    downloads: 0,
    category: 'nvious',
    mode: 'singleplayer'
